// 눈 깜빡임 챙기기 — 주기 샘플링 토글(기본 켜짐). 오늘 평균은 리포트·차트에 표시.
export default function EyeCarePanel() {
  return (
    <details id="eyecare">
      ...
      <div className="hint">
        몇 분마다 잠깐씩(≈30초) 눈 깜빡임을 재서 분당 횟수를 알려줘요. <b>오늘 평균은 리포트와 차트</b>에서
        볼 수 있고, 너무 적으면(눈 건조) 알림을 보냅니다. 배터리를 아끼려고 계속이 아니라 주기적으로만 잽니다.
      </div>
    </details>
  );
}
